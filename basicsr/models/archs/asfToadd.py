...
class MultiScaleProcessBlock(nn.Module):
    ...
    def forward(self,x, x_2, x_4, x_8):
        ...
        x_1=x_1x+self.up2_1(x_2x)
        x_1_fused=x_1
        x_1 = self.conv1(x_1_fused)+x_1_fused
      
        x_2=x_2x+self.down1_2(x_1)+self.up4_2(x_4x)
        x_2_fused=x_2
        x_2 = self.conv2(x_2_fused)+x_2_fused
       
        x_4=x_4x+self.down2_4(x_2)+self.up8_4(x_8x)
        x_4_fused=x_4
        x_4 = self.conv4(x_4_fused)+x_4_fused
       
        x_8=x_8x+self.down4_8(x_4)
        x_8_fused=x_8
...
class MSSM(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        out_temp1=out_finl3+self.up8to4(out_finl4) + inp_enc_level3
        out_temp2 = out_finl2 +self.up4to2(out_temp1) +  inp_enc_level2             
        out_temp3=out_finl1+self.up2to1(out_temp2)  + inp_enc_level1      
