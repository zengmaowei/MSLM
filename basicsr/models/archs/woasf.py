...
class MSSM(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        out_temp1=out_finl3+ inp_enc_level3
        out_temp2 = out_finl2 +  inp_enc_level2             
        out_temp3=out_finl1 + inp_enc_level1      
